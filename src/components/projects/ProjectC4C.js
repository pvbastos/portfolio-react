...
const about = props => (
  ...
  <div className="wrapper-project" id="bux-zero">
    ...
    <div className="text-container">
    <p>This animation was developed with the purpose of visualising and explaining the importance of this initiative.</p>
    </div>
    <div className="text-container">
    <p>Work done in collaboration with <a href={"https://www.linkedin.com/in/milesrouse/"} target="_blank">Miles Rouse</a> and <a href={"https://www.linkedin.com/in/alex-heringa-258b2412b/"} target="_blank">Alex Heringa</a>.</p>
    </div>
